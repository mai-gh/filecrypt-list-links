...
python gen-links.py https://filecrypt.co/Container/XXXXXXXXXX | while read line; do PYTHONPATH=$(pwd)/zippyshare-downloader python -m zippyshare_downloader $line; done
